        ...
        try:
            while True:
                ...
                if first != -1 and last != -1:
                    ...
                    elif 0 < self.d_stop_sign < 30 and stop_sign_active:
...
class ThreadServer(object):
    ...
    distance_thread = threading.Thread(target=server_thread2, args=('192.168.137.1', 8004))
    distance_thread.start()
    video_thread = threading.Thread(target=server_thread('192.168.137.1', 8002))
    video_thread.start()
